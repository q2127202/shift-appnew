# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/14scop.ipynb (unless otherwise specified).

__all__ = ['Parameters', 'Variable', 'Model', 'Constraint', 'Linear', 'Quadratic', 'Alldiff', 'plot_scop']
